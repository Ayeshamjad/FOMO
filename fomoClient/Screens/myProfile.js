        ...
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={{ alignItems: 'center' }}>
                <View style={{ width: 150, height: 150, borderRadius: 75, overflow: 'hidden' }}>
                    <Image style={{ width: '100%', height: '100%', resizeMode: 'cover' }} source={require('../assets/images/bro.png')} />
                </View>
                <Text style={{ marginTop: 10, fontFamily: 'Poppins', fontSize: 20, fontWeight: '600', lineHeight: 30, letterSpacing: 0, textAlign: 'left' }}>Muhammad Ali</Text>
            ...
            <Text style={{ fontFamily: 'Poppins', fontSize: 22, fontWeight: '500', lineHeight: 33, letterSpacing: 0, marginVertical: 10 }}>Feed</Text>
