...
`;
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#FFF4F5' }}>
            ...
            <Image source={require('../assets/images/event2.png')} style={{ width: '100%', height: 300, marginTop: -80, zIndex: -1000 }} />
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, marginTop: 12 }}>
                <Text style={{ fontFamily: 'Poppins', fontSize: 22 }}>Music Night Party</Text>
                <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 20, marginVertical: 12 }}>
                <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <Text style={{ fontFamily: 'Poppins', fontSize: 13, color: 'gray', marginLeft: 5 }}>Miami, USA</Text>
                </View>
                <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginHorizontal: 12 }}>
                    <SvgXml xml={timeSvg} width={12} height={12} />
                    <Text style={{ fontFamily: 'Poppins', fontSize: 13, color: 'gray', marginLeft: 5 }} >18 Jun, 2PM</Text>
                </View>
                {/* </View> */}
            </View>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20 }}>
                ...
                <Text style={{ fontFamily: 'Poppins', fontSize: 14, color: 'gray' }}>Ticket Price: <Text style={{ fontFamily: 'Poppins-Bold', fontSize: 14 }}>$10</Text></Text>
            </View>
            ...
            <Text style={{ fontFamily: 'Poppins', fontSize: 16, color: 'gray', paddingHorizontal: 20, marginTop: 6 }}>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industr standard dummy text ever since the 1500s, when an un known printer took a galley of type and scrambled it to make a type specimen book.
            </Text>

            <View style={{ flexDirection: 'row', alignItems: 'center' , margin: 10, paddingLeft:10}}>
                <Text style={{ fontFamily: 'Poppins', fontSize: 18, fontWeight: '500', lineHeight: 27, letterSpacing: 0, textAlign: 'left', color: '#666666' }}>Total Soled Tickets: 40</Text>
                
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                
                <Text style={{ fontFamily: 'Poppins', fontSize: 18, fontWeight: '500', lineHeight: 27, letterSpacing: 0, textAlign: 'left', color: '#666666', marginLeft: 20 }}>Total Earning: $400</Text>
            </View>
        </View>
    );
};
