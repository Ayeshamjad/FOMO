      ...
      <View style={styles.notificationSection}>
        <TouchableOpacity onPress={handleChatPress}>
          <View style={styles.notification}>
            <Image source={require('../assets/images/events.png')} style={styles.eventImage} />

            <View style={styles.messageContent}>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Text style={styles.messageHeader}>Mega Halloween party</Text>
                <Text style={{ marginLeft: 90 , fontSize: 12, color:"#666666"}}>Today</Text>
              </View>
              <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                <Text style={styles.messageSubtitle}>Hi everyone! thankyou for..</Text>
                <Text style={{ marginLeft: 90 , fontSize: 12, color:"#666666"}}>12:36 AM</Text>
              </View>
            </View>
          </View>
        </TouchableOpacity>
